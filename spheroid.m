...
%      an "inflationary" pattern of deformation. NOTE: This has been
%      changed to a more intuitive negative pressure = deflation
%
...
% Version 1.1, October 13, 2013, USGS (PFC)
...
function sigma = draw
    ...
    CData = zeros(size(X));
    CData(:) = real((strength - sigma)/strength*100);
