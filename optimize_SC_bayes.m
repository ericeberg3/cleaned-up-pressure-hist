...
params = [
    ...
    optimizableVariable('dip', [lb(2), ub(2)], 'Type', 'real', 'Transform', 'none');
    optimizableVariable('strike', [lb(3), ub(3)], 'Type', 'real', 'Transform', 'none');
    optimizableVariable('x1', [lb(4), ub(4)], 'Type', 'real', 'Transform', 'none');
    optimizableVariable('x2', [lb(5), ub(5)], 'Type', 'real', 'Transform', 'none');
    optimizableVariable('x3', [lb(6), ub(6)], 'Type', 'real', 'Transform', 'none');
    optimizableVariable('dpSC', [lb(7), ub(7)], 'Type', 'real', 'Transform', 'none');
];
...
results = bayesopt(@(m) f([m.dpHMM, m.dip, m.strike, m.x1, m.x2, m.x3, m.dpSC]), ...
                   ...
                   'MaxObjectiveEvaluations', 100, 'UseParallel',false, 'GPActiveSetSize', 400, 'IsObjectiveDeterministic', true);
